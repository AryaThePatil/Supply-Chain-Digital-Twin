...
class OptimizationPod:
    ...
    def save(self, path: Optional[str] = None):
        ...
        if self._model is None:
            return
        save_path = path or str(self.checkpoint_dir / "ppo_routing_latest")
    ...
    def load(self, path: Optional[str] = None):
        ...
        if not _sb3_available():
            return
        load_path = path or str(self.checkpoint_dir / "ppo_routing_latest")
    ...
    def _init_ppo(self, env=None):
        ...
        try:
            ...
            load_path = str(self.checkpoint_dir / "ppo_routing_latest")
