...
class AIManager:
    ...
    def record_segment_traversal(self, segment, actual_minutes: float,
        ...
        """Pass traversal data to PredictionPod for ETA learning."""
        if self.prediction_pod:
            self.prediction_pod.record_segment_traversal(segment, actual_minutes, current_time, weather)
